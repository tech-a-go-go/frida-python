...
__version__: str = _sunday.__version__
...
FileMonitor = _sunday.FileMonitor
Cancellable = core.Cancellable

ServerNotRunningError = _sunday.ServerNotRunningError
ExecutableNotFoundError = _sunday.ExecutableNotFoundError
ExecutableNotSupportedError = _sunday.ExecutableNotSupportedError
ProcessNotFoundError = _sunday.ProcessNotFoundError
ProcessNotRespondingError = _sunday.ProcessNotRespondingError
InvalidArgumentError = _sunday.InvalidArgumentError
InvalidOperationError = _sunday.InvalidOperationError
PermissionDeniedError = _sunday.PermissionDeniedError
AddressInUseError = _sunday.AddressInUseError
TimedOutError = _sunday.TimedOutError
NotSupportedError = _sunday.NotSupportedError
ProtocolError = _sunday.ProtocolError
TransportError = _sunday.TransportError
OperationCancelledError = _sunday.OperationCancelledError
