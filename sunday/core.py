...
_Cancellable = _sunday.Cancellable
...
def get_device_manager() -> "DeviceManager":
    ...
    if _device_manager is None:
        _device_manager = DeviceManager(_sunday.DeviceManager())
...
class IOStream:
    ...
    def __init__(self, impl: _sunday.IOStream) -> None:
        self._impl = impl
...
class PortalMembership:
    def __init__(self, impl: _sunday.PortalMembership) -> None:
        self._impl = impl
...
class Script:
    def __init__(self, impl: _sunday.Script) -> None:
        ...
        self._pending: Dict[
            int, Callable[[Optional[Any], Optional[Union[RPCException, _sunday.InvalidOperationError]]], None]
        ] = {}
    ...
    def _rpc_request_async(self, args: Any, data: Optional[bytes] = None) -> asyncio.Future[Any]:
        ...
        def on_complete(value: Any, error: Optional[Union[RPCException, _sunday.InvalidOperationError]]) -> None:
    ...
    def _append_pending(
        self, callback: Callable[[Any, Optional[Union[RPCException, _sunday.InvalidOperationError]]], None]
    ) -> int:
        with self._cond:
    ...
    def _on_destroyed(self) -> None:
        while True:
            ...
            next_pending(None, _sunday.InvalidOperationError("script has been destroyed"))
...
class Session:
    def __init__(self, impl: _sunday.Session) -> None:
        self._impl = impl
    ...
    def setup_peer_connection(
        self, stun_server: Optional[str] = None, relays: Optional[Sequence[_sunday.Relay]] = None
    ) -> None:
        """
...
class Bus:
    def __init__(self, impl: _sunday.Bus) -> None:
        self._impl = impl
...
class Service:
    def __init__(self, impl: _sunday.Service) -> None:
        self._impl = impl
...
DeviceSpawnAddedCallback = Callable[[_sunday.Spawn], None]
DeviceSpawnRemovedCallback = Callable[[_sunday.Spawn], None]
DeviceChildAddedCallback = Callable[[_sunday.Child], None]
DeviceChildRemovedCallback = Callable[[_sunday.Child], None]
DeviceProcessCrashedCallback = Callable[[_sunday.Crash], None]
...
class Device:
    ...
    def __init__(self, device: _sunday.Device) -> None:
    ...
    @cancellable
    def get_frontmost_application(self, scope: Optional[str] = None) -> Optional[_sunday.Application]:
        """
    ...
    @cancellable
    def get_process(self, process_name: str) -> _sunday.Process:
        """
        ...
        if len(matching) == 1:
            ...
            raise _sunday.ProcessNotFoundError(f"ambiguous name; it matches: {matches_list}")
        else:
            raise _sunday.ProcessNotFoundError(f"unable to find process with name '{process_name}'")
    ...
    @cancellable
    def enumerate_pending_spawn(self) -> List[_sunday.Spawn]:
        """
    ...
    @cancellable
    def enumerate_pending_children(self) -> List[_sunday.Child]:
        """
...
DeviceManagerAddedCallback = Callable[[_sunday.Device], None]
DeviceManagerRemovedCallback = Callable[[_sunday.Device], None]
DeviceManagerChangedCallback = Callable[[], None]


class DeviceManager:
    def __init__(self, impl: _sunday.DeviceManager) -> None:
        self._impl = impl
...
class EndpointParameters:
    def __init__(
        ...
        self._impl = _sunday.EndpointParameters(**kwargs)


PortalServiceNodeJoinedCallback = Callable[[int, _sunday.Application], None]
PortalServiceNodeLeftCallback = Callable[[int, _sunday.Application], None]
...
class PortalService:
    def __init__(
        ...
        impl = _sunday.PortalService(*args)
...
class PackageManager:
    def __init__(self) -> None:
        self._impl = _sunday.PackageManager()
...
class Cancellable:
    ...
    @classmethod
    def get_current(cls) -> _sunday.Cancellable:
        """
